...
<div class="container">
	<div class="row">
        ...
        <!-- service name change start -->
            ...
            <div class="banner-sub-name"><h3>Resources</h3></div>
...
<section class="container cartFeature inner-page-content">
  <div class="row">
    <div class="col-xs-12">
      ...
      <h4>WE DO HAVE DIFFERENT PRIVACY AND POLICIES FOR CLIENTS AS WELL AS  EMPLOYEES TOO.</h4>
      </div>
      <h3>1.Overview </h3>
...
<p>Firstly we do try to take less personal information of our client so that our client could feel comfortable in working with us and our website which is been asked to the client for the product services and to fulfill any legal and regulatory requirements.</p>
   ...
   <h3>4.Info that we collect from our Employee</h3>
   <ul class="inner-list">
   ...
   <h3>5.INFO that we collect from clients</h3>
...
<h3>7.CONTACT US</h3>
<p>If you have any query regarding our privacy policy you can also directly ask us through mails or through our website info@tech2globle.com </p>
<h3>8.Security of Collected Information</h3>
