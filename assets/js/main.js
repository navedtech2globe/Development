...
function initDataTable(
  ...
  // this condition will change the length of pagination on timesheet datatable only
  var pagelength = (selector == '.table-timesheets-report') ? -1 : app.options.tables_pagination_limit;
  var dtSettings = {
    ...
    // pageLength: -1, // this will display all content by default on filter
