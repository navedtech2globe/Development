...
<div class="container mb-5"> 
   <div class="counter-outer">
      <div class="counter-icon-outer"><img class="lazyload" src="https://tech2globe.com/images/counter-1.png"></div>
    ...
    <div class="counter-outer">
      <div class="counter-icon-outer"><img class="lazyload" src="https://tech2globe.com/images/counter-2.png"></div>
        <div class="num-counter">
    ...
    <div class="counter-outer">
      <div class="counter-icon-outer"><img class="lazyload" src="https://tech2globe.com/images/counter-3.png"></div>
        <div class="num-counter">
    ...
    <div class="counter-outer">
      <div class="counter-icon-outer"><img class="lazyload" src="https://tech2globe.com/images/counter-4.png"></div>
        <div class="num-counter">
    ...
    <div class="counter-outer">
      <div class="counter-icon-outer"><img class="lazyload" src="https://tech2globe.com/images/counter-5.png"></div>
        <div class="num-counter">
 ...
 <h3 class="h2 text-center text-uppercase mb-4"><strong>Awards &amp; <span class="">Certification</span></strong></h3>
        ...
        <div class="row">
        	<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	<img class="img-responsive lazyloaded" src="https://tech2globe.com/images/awards/amazon-spn.png">
                </div>
            </div>
			...
			<div class="Clientlg-outera"> 
            	<div class="Clientlg">  
                	<img class="img-responsive lazyloaded" src="https://tech2globe.com/images/awards/Payoneer-Log.png">
                </div>
            </div> 
			
			<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	<img class="img-responsive lazyloaded" src="https://tech2globe.com/images/awards/shopify.png">
                </div>
            </div> 
			
			<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	<img class="lazyload img-responsive" src="https://tech2globe.com/images/awards/iso.png">
                </div>
            </div> 			
			
			<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	<img class="lazyload img-responsive" src="https://tech2globe.com/images/awards/flipkart.png">
                </div>
            </div> 	
			...
			<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	<img class="lazyload img-responsive" src="https://tech2globe.com/images/awards/ebay.png">
                </div>
            </div> 	
			...
			<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	<img class="lazyload img-responsive" src="https://tech2globe.com/images/awards/certificate.png">
                </div>
            </div> 	
			...
			<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	<img class="lazyload img-responsive" src="https://tech2globe.com/images/awards/msme.png">
                </div>
            </div> 	
			
			<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	<img class="lazyload img-responsive" src="https://tech2globe.com/images/awards/google.png">
                </div>
            </div> 
      ...
      <div class="container">
	   ...
	   <h3 class="h2 text-center text-uppercase mb-4 text-default"><strong>Featured <span class="">In</span></strong></h3>
        ...
        <div class="row">
        	<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	<img class="img-responsive lazyloaded" src="https://tech2globe.com/images/t2g-your-story.png">
                </div>
            </div>
			...
			<div class="Clientlg-outera"> 
            	<div class="Clientlg">  
                	<img class="img-responsive lazyloaded" src="https://tech2globe.com/images/t2g-behance.png">
                </div>
            </div> 
			
			<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	<img class="img-responsive lazyloaded" src="https://tech2globe.com/images/t2g-themenifest.png">
                </div>
            </div> 
			
			<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	 <img class="lazyload img-responsive" src="https://tech2globe.com/images/t2g-clutch.png">
                </div>
            </div>
			
			<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	 <img class="lazyload img-responsive" src="images/t2g-researchgate.png">
                </div>
            </div>

			<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	   <img class="lazyload img-responsive" src="https://tech2globe.com/images/t2g-goodfirms.png">
                </div>
            </div>
    
			<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	  <img class="lazyload img-responsive" src="https://tech2globe.com/images/t2g-social-media-today.png">
                </div>
            </div>
			
			<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	  <img class="lazyload img-responsive" src="https://tech2globe.com/images/design-rush.png">
                </div>
            </div>
			...
			<div class="Clientlg-outera">
            	<div class="Clientlg">  
                	   <img class="lazyload img-responsive" src="https://tech2globe.com/images/true-pilot.png">
                </div>
            </div>
...
<a href="skype:info.tech2globe" class="transition" tabindex="-1"><img class="lazyload" data-src="images/sprite2.png" /> <span class="small-text rows">Our Skype Id</span> <span class="large-text rows">info.tech2globe</span> </a>
</div>
<div class="clearfix"></div>
<div class="emailid-block voicemsg rows marT20">
        <a href="tel:+91 - 9999875038" class="transition mb-4" tabindex="-1"><img class="lazyload" data-src="images/sprite3.png"> <span class="small-text rows">Call Our Sales Department</span> 
		<span class="large-text rows">IN : +91 - 9999875038</span> 
		</a>
		
        <a href="tel:+1-516-858-5840" class="transition" tabindex="-1"><img class="lazyload" data-src="images/sprite3.png"> <span class="small-text rows">Call Our Sales Department</span> 
