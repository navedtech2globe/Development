...
<div class="container">
	<div class="row">
    	<div class="col-xs-12">
        	...
        	<h1>Amazon.Com Seller central Management</h1>    
  ...
  <div class="container">
    <div class="row">
      <ul class="breadcrumb">
        ...
        <li>Amazon.Com Seller central Management</li>
      </ul>
    </div>
  </div>
</div>
<section class="container cartFeature inner-page-content new-content">
  <div class="row">
    <div class="col-xs-12">
        ...
        <ul class="nav nav-tabs amazon-marketplace-tabs">
          <li class="active"><a data-toggle="tab" href="#amazon1" aria-expanded="true">AMAZON CONSULTANCY AND <br>ACCOUNT LAUNCH SERVICES</a></li>
          <li class=""><a data-toggle="tab" href="#amazon2" aria-expanded="false">AMAZON PRODUCT <br>MARKETING SERVICES</a></li>
          <li class=""><a data-toggle="tab" href="#amazon3" aria-expanded="false">AMAZON SALES <br>BOOST SERVICES</a></li>
          <li class=""><a data-toggle="tab" href="#amazon4" aria-expanded="false">AMAZON ACCOUNT MANAGEMENT <br>AND SUPPORT SERVICES</a></li>
          <div class="clearfix"></div>
        </ul>
        
    <div class="tab-content">
    <div id="amazon1" class="tab-pane fade active in">
         <div class="amazon-service-content-outer amazon-left">
         	<div class="amazon-service-content">
               ...
               <a href="/contact-us" class="btn amazon-btn">Contact Our Amazon Expertise</a>
         	</div>
            <div class="amazon-service-img">
            <img class="lazyload" data-src="images/Amazon-Seller-Onboarding-Management.jpg">

            </div>
            <div class="clearfix"></div>
         </div>
         
         <div class="amazon-service-content-outer amazon-right">
         	<div class="amazon-service-img"><img class="lazyload" data-src="images/Amazon-Seller-Training.jpg"></div>
            <div class="amazon-service-content">
         ...
         <div class="amazon-service-content-outer amazon-left">
            ...
            <div class="amazon-service-img"><img class="lazyload" data-src="images/Amazon-Product-Images-Shoot.jpg"></div>
            <div class="clearfix"></div>
         </div>
         
         <div class="amazon-service-content-outer amazon-right">
         	<div class="amazon-service-img"><img class="lazyload" data-src="images/Amazon-Product-Cataloguing.jpg"></div>
            <div class="amazon-service-content">
          ...
          <div id="amazon2" class="tab-pane fade">
          	<div class="amazon-service-content-outer amazon-left">
              <div class="amazon-service-content">
              ...
              <div class="amazon-service-img"><img class="lazyload" data-src="images/Amazon-Marketing-Services.jpg"></div>
              <div class="clearfix"></div>
            </div>
            
         <div class="amazon-service-content-outer amazon-right">
         	<div class="amazon-service-img"><img class="lazyload" data-src="images/Amazon-Sponsored-Ads.jpg"></div>
            <div class="amazon-service-content">
         ...
         <div class="amazon-service-content-outer amazon-left">
         	<div class="amazon-service-content">
               ...
               <div class="amazon-btn-list">
               		<a href="https://www.amazon.com/dp/B076TGSDYH#aplus3p_feature_div" class="btn" target="_blank">Sample 1</a>
                    <a href="https://www.amazon.com/dp/B078GXZBFF#dpx-aplus-3p-product-description_feature_div" class="btn" target="_blank">Sample 2</a>
                    <a href="https://www.amazon.com/dp/B07GT7XZ6C#dpx-aplus-3p-product-description_feature_div" class="btn" target="_blank">Sample 3</a>
                    <a href="https://www.amazon.com/dp/B01M3XPZCU#dpx-aplus-3p-product-description_feature_div" class="btn" target="_blank">Sample 4</a>
               </div>
               <a href="/contact-us" class="btn amazon-btn">Contact Our Amazon Expertise</a>
         	</div>
            <div class="amazon-service-img"><img class="lazyload" data-src="images/Amazon-Cataloguing.jpg"></div>
            <div class="clearfix"></div>
         </div>
         
         <div class="amazon-service-content-outer amazon-right">
         	<div class="amazon-service-img"><img class="lazyload" data-src="images/Amazon-Storefront-Creation.jpg"></div>
            <div class="amazon-service-content">
          ...
          <div id="amazon3" class="tab-pane fade">
          	<div class="amazon-service-content-outer amazon-left">
              <div class="amazon-service-content">
              ...
              <div class="amazon-service-img"><img class="lazyload" data-src="images/amazon-advertising-optimization.jpg"></div>
              <div class="clearfix"></div>
            </div>
            
         <div class="amazon-service-content-outer amazon-right">
         	<div class="amazon-service-img"><img class="lazyload" data-src="images/Amazon-Headline-Search.jpg"></div>
            <div class="amazon-service-content">
         ...
         <div class="amazon-service-content-outer amazon-left">
            ...
            <div class="amazon-service-img"><img class="lazyload" data-src="images/Amazon-Product-Display-Ads.jpg"></div>
            <div class="clearfix"></div>
         </div>
         
         <div class="amazon-service-content-outer amazon-right">
         	<div class="amazon-service-img"><img class="lazyload" data-src="images/Amazon-Enhanced-Brand-Content.jpg"></div>
            <div class="amazon-service-content">
          ...
          <div id="amazon4" class="tab-pane fade">
          	<div class="amazon-service-content-outer amazon-left">
              <div class="amazon-service-content">
              ...
              <div class="amazon-service-img"><img class="lazyload" data-src="images/Amazon-Seller-Account-Management.jpg"></div>
              <div class="clearfix"></div>
            </div>
            
         <div class="amazon-service-content-outer amazon-right">
         	<div class="amazon-service-img"><img class="lazyload" data-src="images/Amazon-Vendor-Account-Management.jpg"></div>
            <div class="amazon-service-content">
         ...
         <div class="amazon-service-content-outer amazon-left">
            ...
            <div class="amazon-service-img"><img class="lazyload" data-src="images/Amazon-Seller-Account-Reinstatement.jpg"></div>
            <div class="clearfix"></div>
         </div>
         
         <div class="amazon-service-content-outer amazon-right">
         	<div class="amazon-service-img"><img class="lazyload" data-src="images/Amazon-Bilingual-Translation.jpg"></div>
            <div class="amazon-service-content">
        ...
        <div class="logo-outer">
        	<div class="logo-img-outer"><a href="https://services.amazon.com/solution-providers/#/ebcontentServiceProvider/US/ebcontent/Tech2Globe/a4ff6f36-3bf1-483b-9340-c36166c2655c?localeSelection=en_US" target="_blank"><img class="lazyload" data-src="images/online-logo-1.jpg"></a></div>
            <div class="logo-img-outer"><a href="https://sellercentral.amazon.in/tsba/provider-details/Account%20Management/e624d8bb-038f-4e19-97bf-0f949769944b?ref_=sc_spn_blst_bdt-e624d8bb&sellFrom=IN&sellIn=IN" target="_blank"><img class="lazyload" data-src="images/online-logo-2.jpg"></a></div>
            <div class="logo-img-outer"><a href="/contact-us" target="_blank"><img src="images/online-logo-3.jpg"></a></div>
            <div class="logo-img-outer"><a href="https://services.amazon.com/solution-providers/#/adoptimizationServiceProvider/US/adoptimization/Tech2Globe/ede3736b-b0aa-402d-8c28-f4dc40acb404?localeSelection=en_US" target="_blank"><img class="lazyload" data-src="images/online-logo-4.jpg"></a></div>
        </div>
      </div>
  ...
  <div class="col-xs-12">   
       ...
       <div class="row">
          <ul class="expertise-list">
            <li><a href="amazon-consulting-services.php" class="btn">Amazon Consulting Services</a></li>
            <li><a href="online-business-management-flipkart" class="btn">Flipkart</a></li>
            <li><a href="online-business-management-amazon-in" class="btn">Amazon India</a></li>
            <li><a href="eBay-management" class="btn">eBay India</a></li>
          </ul>
          
          <ul class="expertise-list">
          <li><a href="nop-commerce-development" class="btn">Nopcommerce Development</a></li>
          <li><a href="volusion-development" class="btn">Volusion Development</a></li>
          <li><a href="3dcart-development" class="btn">3Dcart Development</a></li>
          <li><a href="open-cart-development" class="btn">Open Cart Development</a></li>
          </ul>
