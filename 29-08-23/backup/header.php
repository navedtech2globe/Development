...
<br>
                     ...
                     <!--      <?php include("include/resource.php"); ?>
                          <div class="submenu-img">
                              <img src="images/menu-bpo-kpo.jpg" class="img-fluid">
                          </div> -->
                       </div>
                       ...
                       <div class="tab-pane" id="Software">   
                           ...
                           <?php include("include/resource.php"); ?>
                           <div class="submenu-img">
                              <img src="img/web-and-mobile-menu-banner.png" class="img-fluid">
                            </div>
                       </div>
...
<!--                        <div class="tab-pane" id="Oracle-Products-Solutions">   
                            ...
                            <div class="submenu-img">
                              <img src="images/menu-oracle.jpg" class="img-fluid">
                            </div>
                       </div> -->
 ...
 -->
                            ...
                            <div class="submenu-img">
                              <img src="img/side-menu-ads-commer.png" class="img-fluid">
                            </div>
                       ...
                       <div class="tab-pane" id="Digital-Marketing"> 
						...
						<ul class="submenu3">
                            ...
                            <div class="submenu-img">
                              <img src="img/side-menu-ads-banners.png" class="img-fluid">
                            </div>
                       </div>
                    </div>
...
<!-- Technologies Web View Menu-->
        <li class="dropdown servie-menu"> <a aria-expanded="false" role="button" data-toggle="dropdown" class="dropdown-toggle" href="javascript:void(0)"><img class="menu-icon lazyload" src="/images/icons/techno.png" />technologies</a>
              ...
              <div role="menu" class="dropdownMenu2 dropdown-menu service-dropdown">
                    <div class="tab-content menu-tab-content">   
                       <div class="tab-pane active" id="Custom-web" style="color:#000">   
                            ...
                            <?php include("include/resource.php"); ?>
                            <!--<div class="submenu-img">
                              <a href="/contact-us"><img src="images/menu-ecommerce.jpg" class="img-fluid"></a>
                            </div>--->
                       </div>
                       ...
                       <div class="tab-pane" id="eCommerce-solutions">   
                        ...
                        <?php include("include/resource.php"); ?>
                          <div class="submenu-img">
                              <img src="images/amazon/amazon-spn.jpg" class="img-fluid">
                          </div>
                       </div>
...
<!-- 
             ...
             <a href="/startup-consulting">
              ...
              <li><a href="/contact-us"><img class="menu-icon lazyload" src="https://www.tech2globe.com/images/menu-icon-5.png" />Contact us</a></li>
