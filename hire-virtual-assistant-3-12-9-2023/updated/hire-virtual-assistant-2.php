...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="/hire-virtual-assistant-2/images/favicon.ico">
        ...
        <div class="container">
            <div class="row sub-section-a d-flex justify-content-between align-items-center">
                ...
                <div class="col-md-5 col-lg-5 col-xl-5 col-xxl-5 col-sm-12 col-xs-12">
                    <figure class="w-75">
                        <img class="w-100" src="/hire-virtual-assistant-2/images/hire-virtual-assistant-banner2.2.png" alt="">
                    </figure>
                </div>
            </div>
        </div>
            ...
            <div class="row d-flex justify-content-center">
                    ...
                    <div class="card">
                        <div class="heading-container">
                            <figure class="icon w-25">
                                <img class="w-100" src="/hire-virtual-assistant-2/images/data-entry-service.png" alt="">
                            </figure>
                            <div class="heading-4">
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 col-xxl-3 col-sm-12 col-xs-12 card-container-section-b">
                    <div class="card">
                        <div class="heading-container">
                            <figure class="icon w-25">
                                <img class="w-100" src="/hire-virtual-assistant-2/images/data-processing.png" alt="">
                            </figure>
                            <div class="heading-4">
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 col-xxl-3 col-sm-12 col-xs-12 card-container-section-b">
                    <div class="card">
                        <div class="heading-container">
                            <figure class="icon w-25">
                                <img class="w-100" src="/hire-virtual-assistant-2/images/data-conversion.png" alt="">
                            </figure>
                            <div class="heading-4">
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 col-xxl-3 col-sm-12 col-xs-12 card-container-section-b">
                    <div class="card">
                        <div class="heading-container">
                            <figure class="icon w-25">
                                <img class="w-100" src="/hire-virtual-assistant-2/images/data-extraction.png" alt="">
                            </figure>
                            <div class="heading-4">
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 col-xxl-3 col-sm-12 col-xs-12 card-container-section-b">
                    <div class="card">
                        <div class="heading-container">
                            <figure class="icon w-25">
                                <img class="w-100" src="/hire-virtual-assistant-2/images/data-scraping.png" alt="">
                            </figure>
                            <div class="heading-4">
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 col-xxl-3 col-sm-12 col-xs-12 card-container-section-b">
                    <div class="card">
                        <div class="heading-container">
                            <figure class="icon w-25">
                                <img class="w-100" src="/hire-virtual-assistant-2/images/customer-support-service.png" alt="">
                            </figure>
                            <div class="heading-4">
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 col-xxl-3 col-sm-12 col-xs-12 card-container-section-b">
                    <div class="card">
                        <div class="heading-container">
                            <figure class="icon w-25">
                                <img class="w-100" src="/hire-virtual-assistant-2/images/business-process-outsourcing.png" alt="">
                            </figure>
                            <div class="heading-4">
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 col-xxl-3 col-sm-12 col-xs-12 card-container-section-b">
                    <div class="card">
                        <div class="heading-container">
                            <figure class="icon w-25">
                                <img class="w-100" src="/hire-virtual-assistant-2/images/backend-support-services.png" alt="">
                            </figure>
                            <div class="heading-4">
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 col-xxl-3 col-sm-12 col-xs-12 card-container-section-b">
                    <div class="card">
                        <div class="heading-container">
                            <figure class="icon w-25">
                                <img class="w-100" src="/hire-virtual-assistant-2/images/knowledge-process-outsourcing.png" alt="">
                            </figure>
                            <div class="heading-4">
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 col-xxl-3 col-sm-12 col-xs-12 card-container-section-b">
                    <div class="card">
                        <div class="heading-container">
                            <figure class="icon w-25">
                                <img class="w-100" src="/hire-virtual-assistant-2/images/chat-support-services.png" alt="">
                            </figure>
                            <div class="heading-4">
        ...
        <div class="container mt-2">
            <div class="row my-5 text-center d-flex justify-content-between align-items-center our-valued-customer gap-4">
                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                    <figure>
                        <img src="/hire-virtual-assistant-2/images/blue-angel-logo.jpg" alt="">
                    </figure>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                    <figure>
                        <img src="/hire-virtual-assistant-2/images/medicover-f-logo.jpg" alt="">
                    </figure>
                </div>

                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                    <figure>
                        <img src="/hire-virtual-assistant-2/images/abrams.jpg" alt="">
                    </figure>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                    <figure>
                        <img src="/hire-virtual-assistant-2/images/frontier.jpg" alt="">
                    </figure>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                    <figure>
                        <img src="/hire-virtual-assistant-2/images/your-life-1.jpg" alt="">
                    </figure>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                    <figure>
                        <img src="/hire-virtual-assistant-2/images/aspire-1.jpg" alt="">
                    </figure>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                    <figure>
                        <img src="/hire-virtual-assistant-2/images/fleur-de-1.jpg" alt="">
                    </figure>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                    <figure>
                        <img src="/hire-virtual-assistant-2/images/ms-glamour.jpg" alt="">
                    </figure>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                    <figure>
                        <img src="/hire-virtual-assistant-2/images/creative.jpg" alt="">
                    </figure>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                    <figure>
                        <img src="/hire-virtual-assistant-2/images/indiaSoft.jpg" alt="">
                    </figure>
                </div>
            </div>
